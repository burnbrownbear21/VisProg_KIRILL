    ...
    , ui(new Ui::MainWindow)
{
    ...
    //  массивы силы сигнала от каждой базовой станции до каждой точки на карте
    ...
    for(int x = 0; x < mapWidth; x++){
        for(int y = 0; y < mapHeight; y++){
            // расстояние между текущей базовой станцией и текущей точкой на карте
            float distance = sqrt(pow(cellPosX-x, 2) + pow(cellPosY-y, 2));
    // Сила сигнала на основе расстояния
    float signalStrength = 1.0/(1.0 + pow(distance/50.0, 2));
    // Сила сигнала к массиву для текущей точки на карте
    ...
    // цвет и прозрачность каждой точки на карте на основе массива силы сигнала
    for(int x = 0; x < mapWidth; x++){
        for(int y = 0; y < mapHeight; y++){
            ...
            // прозрачность на основе силы сигнала
            int alpha = std::min(75, static_cast<int>(signalStrength*255));
            // прямоугольник для текущей точки на карте
            QGraphicsRectItem* rect = new QGraphicsRectItem(x, y, 1, 1);
            // цвет и прозрачность прямоугольника
